...
import { EXCHANGE_RATE, KR_WITHHOLDING_TAX, GLOBAL_WITHHOLDING_TAX } from "../../lib/constants";
...
export default function MyPage() {
  ...
  const formatPoints = (points: number) => {
    if (lang === "ko") {
      return `${points.toLocaleString()}P (₩${points.toLocaleString()})`;
    } else if (lang === "en") {
