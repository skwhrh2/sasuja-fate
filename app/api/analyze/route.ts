...
// 3. 수비학(수리학) 핵심수 1~9 데이터
// 피타고라스 수비학: 생년월일 각 자리 숫자를 1자리가 될 때까지 반복 합산
const NUMEROLOGY_MAP: Record<number, { num: number; vibration: string; meaning: string }> = {
  1: { num: 1, vibration: "스스로 길을 개척하는 선구자의 강렬한 독립 에너지", meaning: "1은 모든 수의 시작이자 리더십의 상징입니다. 남이 닦아놓은 길보다 자신만의 새로운 길을 열어가는 개척자 기질을 타고났습니다. 독립심과 추진력이 강하며, 스스로 결정하고 책임지는 삶에서 가장 큰 빛을 발합니다. 다소 외로운 길일지라도 자신의 신념을 꺾지 않는 굳건한 의지가 인생의 큰 자산입니다." },
  2: { num: 2, vibration: "따뜻한 배려와 조화로 사람들을 부드럽게 이어주는 사랑의 에너지", meaning: "2는 균형과 협력의 수입니다. 혼자 빛나기보다 누군가와 함께할 때 더 깊은 행복을 느끼는 온화한 성품을 지녔습니다. 섬세한 감수성과 뛰어난 공감 능력으로 주변 사람들의 마음을 세심하게 어루만지며, 갈등을 부드럽게 중재하는 평화의 가교 역할을 자연스럽게 해냅니다." },
  3: { num: 3, vibration: "넘치는 창의력과 밝은 표현력으로 세상을 환하게 물들이는 기쁨", meaning: "3은 창조와 표현의 수입니다. 풍부한 상상력과 유쾌한 언변으로 어디서든 분위기를 밝히는 천성적인 이야기꾼입니다. 예술, 글쓰기, 말하기 등 자신을 표현하는 모든 분야에서 재능을 발휘하며, 사람들에게 웃음과 영감을 선사하는 것에서 진정한 보람을 느낍니다." },
  4: { num: 4, vibration: "한 걸음 한 걸음 착실하게 쌓아올리는 신뢰와 안정의 에너지", meaning: "4는 성실과 기초의 수입니다. 화려한 지름길보다 묵묵히 정도를 걷는 성실함이 최대의 무기입니다. 꼼꼼하고 체계적인 사고방식으로 어떤 일이든 탄탄한 기반 위에 쌓아올리며, 오랜 시간 신뢰를 쌓아 주변 모든 사람들이 가장 먼저 기댈 수 있는 든든한 버팀목이 됩니다." },
  5: { num: 5, vibration: "자유롭게 세상을 누비며 새로운 경험을 탐험하는 역동적인 에너지", meaning: "5는 자유와 변화의 수입니다. 틀에 박힌 일상보다 새로운 자극과 변화가 있을 때 생동감이 넘칩니다. 다양한 분야에 걸친 폭넓은 경험과 뛰어난 적응력이 강점이며, 어떤 환경에서도 유연하게 기회를 포착하고 삶에 활력을 불어넣는 모험가적 기질을 타고났습니다." },
  6: { num: 6, vibration: "사랑하는 이들을 위해 헌신하며 따뜻한 보금자리를 만드는 책임의 에너지", meaning: "6은 사랑과 책임의 수입니다. 가족과 가까운 이들을 향한 헌신적인 사랑이 삶의 가장 큰 원동력입니다. 누군가를 돌보고 보살피는 일에서 깊은 보람을 느끼며, 아름다운 것을 알아보는 심미안과 조화로운 환경을 만드는 능력으로 주변을 따뜻하고 아늑한 공간으로 만들어냅니다." },
  7: { num: 7, vibration: "세상의 이면을 꿰뚫어 보는 깊은 통찰과 지혜의 에너지", meaning: "7은 탐구와 지혜의 수입니다. 표면에 드러난 것에 만족하지 않고 사물의 본질과 깊은 이면을 탐구하는 철학적인 성향을 지녔습니다. 혼자만의 조용한 시간 속에서 빛나는 통찰을 얻으며, 학문·연구·명상 등 깊이 있는 분야에서 남들이 쉽게 도달하지 못하는 경지에 이르는 지혜를 품고 있습니다." },
  8: { num: 8, vibration: "강한 의지와 리더십으로 물질적 성공과 풍요를 이끌어내는 에너지", meaning: "8은 풍요와 권위의 수입니다. 크고 담대한 목표를 향해 흔들리지 않는 강인한 의지와 추진력이 가장 큰 자산입니다. 비즈니스 감각과 실행력이 뛰어나 물질적 성공을 현실로 만들어내는 능력을 타고났으며, 책임감 있는 리더로서 조직과 공동체를 힘차게 이끌어나가는 타고난 역량을 보여줍니다." },
  9: { num: 9, vibration: "넓은 세상을 품는 포용력과 이타심으로 빛을 나누는 완성의 에너지", meaning: "9는 완성과 인류애의 수입니다. 개인의 이익보다 더 넓은 세상과 사람들을 위한 헌신에서 삶의 참된 의미를 발견합니다. 풍부한 인생 경험에서 우러나온 깊은 지혜와 포용력으로 주변에 영감을 주며, 예술·교육·봉사 등 인류의 삶을 풍요롭게 하는 분야에서 진정한 빛을 발하는 완성된 영혼입니다." }
};

/**
 * 피타고라스 수비학 핵심수 계산
 * 생년월일의 각 자리 숫자를 1~9가 될 때까지 반복 합산
 * 예) 1990-01-15 → 1+9+9+0+0+1+1+5 = 26 → 2+6 = 8
 */
function calcCoreNumber(year: number, month: number, day: number): number {
...
export async function POST(request: Request) {
  ...
  try {
    ...
    // 수비학(수리학) 핵심수 계산 - 피타고라스 수비학 (생년월일 자리수 합산)
    const coreNum = calcCoreNumber(solarYear, solarMonth, solarDay);
    const numData = NUMEROLOGY_MAP[coreNum];
...
`;
    ...
    try {
      ...
      console.warn("[WARN] Primary model (gemini-3.1-flash-lite) failed. Falling back to gemini-3.1-flash...", apiErr.message);
      response = await ai.models.generateContent({
